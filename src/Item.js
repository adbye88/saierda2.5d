...
const ITEMS = {
  ...
  soldierSword:     { name: '士兵之剑',       type: 'weapon', subtype: 'sword', icon: '⚔️', atk: 14, durability: 30,  desc: '海拉鲁士兵的制式长剑。' },
  knightSword:      { name: '骑士之剑',       type: 'weapon', subtype: 'sword', icon: '⚔️', atk: 26, durability: 40,  desc: '骑士团精英的精钢剑。' },
  royalSword:       { name: '王族之剑',       type: 'weapon', subtype: 'sword', icon: '⚔️', atk: 36, durability: 50,  desc: '海拉鲁王族传承的名剑。' },
  masterSword:      { name: '大师之剑',       type: 'weapon', subtype: 'sword', icon: '🌟', atk: 30, durability: 999, desc: '驱魔之剑，常态攻击30；面对守护者、神兽与灾厄时觉醒为60。' },
  ...
  ancientShortSword:{ name: '古代兵装·剑',    type: 'weapon', subtype: 'sword', icon: '⚔️', atk: 40, durability: 55, desc: '古代希卡技术的产物，对守护者伤害加成。' },
  ancientGreatsword:{ name: '古代兵装·大剑',  type: 'weapon', subtype: 'claymore', icon: '⚔️', atk: 58, durability: 55, desc: '古代技术打造的重剑，适合对付大型敌人。' },
  forestDwellerSword:{ name: '森民之剑',      type: 'weapon', subtype: 'sword', icon: '🌿', atk: 22, durability: 35, desc: '森林工匠打造的轻剑，挥动迅速。' },
  ...
  eightfoldBlade:   { name: '戒心小刀',       type: 'weapon', subtype: 'sword', icon: '🗡️', atk: 30, durability: 30, desc: '隐秘战士使用的短刀，背刺伤害高。' },
  savageLynelSword: { name: '兽神剑',         type: 'weapon', subtype: 'sword', icon: '🦁', atk: 58, durability: 42, desc: '强敌战利品，破坏力惊人。' },

  // ============ 双手剑/长枪 ============
  bokoBoneSpear:    { name: '波克布林之骨枪', type: 'weapon', subtype: 'spear', icon: '🔱', atk: 8,  durability: 15,  desc: '骨头拼成的长枪，攻击距离较远。' },
  soldierSpear:     { name: '士兵之枪',       type: 'weapon', subtype: 'spear', icon: '🔱', atk: 12, durability: 30,  desc: '制式长枪，可远距离戳刺。' },
  knightHalberd:    { name: '骑士之斧枪',     type: 'weapon', subtype: 'spear', icon: '🔱', atk: 22, durability: 40,  desc: '骑士团的重型长柄武器。' },
  royalHalberd:     { name: '王族之斧枪',     type: 'weapon', subtype: 'spear', icon: '🔱', atk: 30, durability: 50,  desc: '王族近卫的长柄武器。' },
  ...
  soldierClaymore:  { name: '士兵双手剑',     type: 'weapon', subtype: 'claymore', icon: '⚔️', atk: 20, durability: 32, desc: '士兵装备的重剑。' },
  knightClaymore:   { name: '骑士双手剑',     type: 'weapon', subtype: 'claymore', icon: '⚔️', atk: 34, durability: 45, desc: '骑士团用于破阵的重剑。' },
  royalClaymore:    { name: '王族双手剑',     type: 'weapon', subtype: 'claymore', icon: '⚔️', atk: 52, durability: 55, desc: '王族近卫的高阶重剑。' },
  royalGuardClaymore:{ name: '近卫双手剑',    type: 'weapon', subtype: 'claymore', icon: '⚔️', atk: 64, durability: 28, desc: '王城近卫的决战重剑，威力高但耐久较低。' },
  ...
  soldierBow:       { name: '士兵之弓',       type: 'bow', icon: '🏹', durability: 35, atk: 10, desc: '士兵用的强弓。' },
  knightBow:        { name: '骑士之弓',       type: 'bow', icon: '🏹', durability: 50, atk: 15, desc: '骑士团的精制弓。' },
  royalBow:         { name: '王族之弓',       type: 'bow', icon: '🏹', durability: 60, atk: 25, desc: '王族的高级弓。' },
  ancientBow:       { name: '古代兵装·弓',    type: 'bow', icon: '🏹', durability: 70, atk: 30, desc: '古代技术的精准弓。' },
  greatEagleBow:    { name: '大鹫弓',         type: 'bow', icon: '🏹', durability: 65, atk: 34, desc: '利特英杰传承的强弓，射程与稳定性出众。' },
  ...
  forestDwellerBow: { name: '森民之弓',       type: 'bow', icon: '🏹', durability: 42, atk: 14, desc: '森林工匠制作的轻弓。' },
  falconBow:        { name: '飞燕弓',         type: 'bow', icon: '🏹', durability: 50, atk: 20, desc: '利特族使用的远射弓。' },
  duplexBow:        { name: '二连弓',         type: 'bow', icon: '🏹', durability: 32, atk: 18, desc: '一次射出两束箭影，爆发强。' },
  savageLynelBow:   { name: '兽神弓',         type: 'bow', icon: '🏹', durability: 45, atk: 32, desc: '强敌战利品，威力极高。' },
