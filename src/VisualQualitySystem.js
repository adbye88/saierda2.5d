...
const VisualQualitySystem = {
  ...
  budgets: {
    ...
    medium: {
      ...
      detailRadius: 58,
      landmarkRadius: 92,
      silhouetteRadius: 240,
      treeProxyRadius: 210,
      frontBoost: 30,
      enemyInterval: 0.16,
      passiveEnemyInterval: 0.22,
      propInterval: 0.32,
      detailDensity: 0.55,
      particleFactor: 0.5,
      minimapRealtimeEnemies: 20,
      minimapFarEnemies: 35,
      minimapDrops: 16,
      minimapNpcs: 12,
      minimapGates: 10,
    ...
    high: {
      ...
      detailRadius: 78,
      landmarkRadius: 138,
      silhouetteRadius: 320,
      treeProxyRadius: 280,
      frontBoost: 38,
      enemyInterval: 0.1,
      passiveEnemyInterval: 0.14,
      propInterval: 0.24,
      detailDensity: 0.78,
      particleFactor: 0.75,
      minimapRealtimeEnemies: 32,
      minimapFarEnemies: 60,
      minimapDrops: 24,
      minimapNpcs: 18,
      minimapGates: 14,
    ...
    ultra: {
      ...
      detailRadius: 94,
      landmarkRadius: 164,
      silhouetteRadius: 380,
      treeProxyRadius: 340,
      frontBoost: 46,
      enemyInterval: 0.08,
      passiveEnemyInterval: 0.1,
      propInterval: 0.2,
      detailDensity: 1,
      particleFactor: 1,
      minimapRealtimeEnemies: 48,
      minimapFarEnemies: 90,
      minimapDrops: 36,
      minimapNpcs: 24,
      minimapGates: 18,
